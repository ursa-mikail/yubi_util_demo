...
wget https://raw.githubusercontent.com/yourusername/yubikey-piv-manager/main/yubikey_manager.sh

# Make it executable
chmod +x yubikey_manager.sh
...
SHARES_DIR="$HOME/yubikey_shares"
LOG_FILE="$HOME/yubikey_manager.log"
...
bash
tail -f $HOME/yubikey_manager.log
